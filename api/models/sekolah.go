...
type Sekolah struct {
	...
	NamaAdmin    string         `gorm:"size:100;not null" json:"nama_admin"`
	JabatanAdmin string         `gorm:"size:50;not null" json:"jabatan_admin"`
	NoWaAdmin    string         `gorm:"size:20;not null" json:"no_wa_admin"`
	EmailAdmin   string         `gorm:"size:100;not null" json:"email_admin"`
